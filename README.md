...
固定座標には **ネザー要塞** がそびえている: 4 方向へ 40 ブロック伸びる
ネザーレンガの橋, 橋をまたぐアーチ型の**門塔**, そして中央の**砦** (壁・屋根・
狭間窓・屋上の胸壁・グロウストーンの照明を備えた 13x13 の城塞) からなる
大型構造物で, 砦の中の **3 つの宝箱**には初めて踏み込んだときにネザー水晶・
金・ブレイズロッド・ダイヤ・金のリンゴなどが詰まる。
ソウルサンドの上は歩くのが遅くなり, ベッドで眠ろうとすると爆発するので注意。
**ネザーに到着すると, すぐ後ろに帰り用の黒曜石ポータルが自動で建つ**
(本家準拠)。それに乗ればオーバーワールドの元の場所へ戻れる
(帰還地点はワールドと一緒に保存されるので, リロード後も迷子にならない)。
...
スポーンから北東 (X+420, Z+420 あたり) には**ジャングル地帯**が広がっている。
背の高いジャングルの木と濃い下草に覆われたこの土地の中心には,
苔むした石レンガの**大神殿** (25x25, 11 段のピラミッド) がそびえる。
南側の大きな門から祭壇のある大広間へ入り, 奥の階段を地下へ降りると,
そこは**石の大迷宮** — 29x29 の入り組んだ迷路が待ち構えている。
迷路には**トラップ**が仕掛けられており, 壁のすき間から毒矢が飛んでくるセルや,
「カチッ」と音がした 1 秒後に爆風が吹き上がるセルがある
(爆発のトラップは**床のひび割れ**が目印。よく見て避けよう)。
迷路を抜けると列柱が並ぶ**衛兵の間** (宝箱 1) , その先がグロウストーンに
照らされた**ポータルの間**だ。2 つの宝箱 (ダイヤ・金・エンダーパールなど) と,
渦を巻く水色の**スカイポータル**がプレイヤーを待っている。

なお, **神殿のブロックは古代の魔法で守られており, サバイバルでは壊せない**
(TNT や爆発でも壊れない)。壁を掘って迷路やトラップをショートカットすることは
できず, 正面から攻略するしかない (クリエイティブでは自由に編集できる)。

ポータルをくぐると, スポーンからほどよく離れた場所の上空に浮かぶ**空島**へ
ワープする。空島は「雲に乗っている」イメージの島で, ふわふわの**雲ブロック**に
土がまだらに混ざり, 草地には下界には無い固有の植物 — 淡い水色の**空草**,
ほのかに光る**星の花**, 白い幹に桜色の**空葉**を茂らせた**空の木** — が生えている。
到着地点は島の西端にある雲の桟橋で, ボスのいる中央の広場までは
雲の草原を歩いて (あるいは飛んで) 向かうことになる。
初めてポータルを通ったときに**「空の加護」**を永続的に獲得し, 空島の空域を漂う
**毒の瘴気**が無効になる — 加護なしでブロックを高く積んで空島へ登ろうと
すると, 高度 96 を超えたあたりから毒に侵されて死んでしまう
(空島へは必ず神殿のポータルから行くことになる)。

広大な空島の中央だけは石レンガの**広場 (ボスアリーナ)** になっており, 初めて訪れると
黄金の巨鳥 **「空の守護者」** (体力 120, ファイアボールを放つ) が現れる。
画面上部のボス HP バーを見ながら討伐すると, ダイヤモンドと金ブロックを
落とし, 大量の経験値 (300) が手に入る。アリーナの宝箱 3 つにはダイヤブロックや
金のリンゴなどの宝が眠っており, 東の空に浮かぶ**衛星の小島**にも
宝箱が 1 つ隠されている (鳥に乗って取りに行こう)。

島には水色の**空の鳥**が 3 羽住んでいる。**ボスを討伐すると 1 羽が自動的に
仲間になる** (小麦か種を手に右クリックして手なずけることもできる)。
仲間になった鳥を右クリックすると**騎乗**でき, 移動キー + ジャンプ/スニークで
**サバイバルでも自由に空を飛べる** (F キーまたは飛行ボタンで降りる)。
仲間の鳥はワールドに記録され, **画面左上のホイッスルボタン (🕊) か B キー**で
いつでもどこでも呼び寄せられる (どれだけ離れていても飛んでくる)。
帰りは到着地点と同じ, 島の西端の桟橋のスカイポータルで神殿へ戻れる。
...
- **3 種類の木**: オーク (標準) / **白樺** (細く高い幹と明るい黄緑の葉) /
  **ダークオーク** (低く角ばった密な樹冠と深い緑の葉) が森や平原に混ざって
  生える。苗木からもランダムでいずれかの樹種が育ち、原木からはそれぞれの
  木材 (原木 1 → 木材 4) がクラフトできる
- **骨粉 (本家準拠)**: ホネ 1 個 → 骨粉 3 個をクラフト。小麦に使うと
  1 段階成長し、苗木に使うと約 45% の確率でその場で木に成長する
- **糸 (本家準拠)**: クモを倒すとドロップ。**弓 (棒 3 + 糸 3)**・
  **釣竿 (棒 3 + 糸 2)**・**羊毛 (糸 4)** の材料になる (羊毛レシピから本家準拠に変更)
- **リンゴと金のリンゴ (本家準拠)**: オーク / ダークオークの葉から約 0.5% で
  **リンゴ** (回復 4) がドロップ。金インゴット 8 + リンゴで**金のリンゴ**を
  クラフトでき、食べると満腹度に加えて体力も 2 ハート即回復する
  (満腹でも食べられる)
- **ダッシュの満腹度制限 (本家準拠)**: 満腹度が 6 以下になるとダッシュ
  できなくなる (自然回復に満腹度 18 以上が必要なのは実装済み)
- **モブの模様入りスキン**: ボックスモデルの単色に加え, ブロックと同じ
  実行時生成テクスチャをモブにも貼れる仕組みを用意し, ほぼ全モブに適用。
  ゾンビ (まだらな腐敗した肌 + ぼろぼろの服)、ヒツジ (もこもこした毛玉状の
  羊毛)、**クリーパー** (デザイン画から起こした 16x16 のドット絵。明るい緑の
  迷彩に灰白のパッチが混ざり、顔は四角い両目と T 字の口・牙。脚は下 1/3 が
  暗い緑と黒の足元になる専用テクスチャ)、牛 (茶白のまだら模様)、
...
- **松明**: 小型光源 (光量 14)。夜の探検や坑道の明かりに。本家同様に
  **壁の側面に掛けて設置**もでき、壁掛け松明は壁から斜めに突き出た見た目に
  なる。支えの壁を壊すと外れて松明アイテムに戻る
