...
燃え続けるので要注意。最低限の明るさを底上げしてあるので, 松明やマグマの
光が無い場所でも真っ暗にはならず周囲が見える。**ネザー水晶鉱石**を掘って集めれば, クォーツブロックの
...
- **描画 (影MOD風)**:
  ...
  - 水/マグマの流動: バケツで平地に注いだり、隣接ブロックを壊して空きを作ると、
    発生源から四方 (十字状) に本家同様の見た目で広がっていく。水は最大7マス、
    マグマは最大4マスまで。下が空いていればそのまま流れ落ちる
