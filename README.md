...
**このゲームの目標**: 様々な建築ブロック (本家にないオリジナルブロックを含む) を
そろえて、より良い建築ができるようにすること。そして Claude Code が建築した
**「クロードの街」** が全ワールドに生成され、その世界でプレイできること。
スポーン地点の東すぐに街があります。

![screenshot](docs/screenshot.png)

「クロードの街」— Claude Code が全ワールドに建築する街:

![claude town](docs/screenshot_town.png)
...
- **バイオーム**: 平原 / 森林 / 砂漠 / 雪山。大陸ノイズによる海と砂浜、
  リッジノイズによる山脈
- **洞窟と鉱石**: 3 種類の洞窟 (塊状の洞窟 / 細長いスパゲッティトンネル /
  深層の大空洞) が絡み合う地下世界。石炭・鉄・金・ダイヤ・黒曜石が深さ別に分布
- **村の生成**: 世界のあちこちに村が自動生成される。木の家 (ガラス窓・
  ハーフブロック屋根・室内松明つき) が石の井戸を囲み、夜は明かりが灯る
- **木と植生**: バイオームに応じた密度で木・草・花 (タンポポ / ポピー) を自動生成
- **クロードの街**: すべてのワールドのスポーン地点近く (東側) に、
  Claude Code が設計した街が自動生成される:
  - **中央広場**: チェッカー模様の床 + 大理石の噴水 (グロウストーンの光る柱)、
    スチール柱 + シアンネオンの街灯 4 本
  - **アスファルト道路**: 白線入りの道が広場から東西南北へ延びる
  - **クロード城**: 石レンガの城壁 (狭間つき) と 4 本のコーナータワー、
    クォーツの床、レッドカーペット、金の玉座、朱色の旗
  - **三重の塔 (パゴダ)**: 畳の床 / 障子の壁 / 朱色の柱 / 反りのある屋根、
    頂上に金の相輪
  - **モダンハウス**: クォーツの壁 + 黒スモークガラスの大窓 + スチールの
    フラットルーフ + ピンクネオンのアクセント
  - **公園**: 大理石縁の池、わらぶき屋根のガゼボ、ベンチ、花壇、木
  - **CLAUDE ネオンサイン**: 黄色ネオンのドット文字で描いた大看板
  - **虹のアーチ** と **空に浮かぶ雲の島** (クリスタルつき展望台)
  - 街に入ると「クロードの街へようこそ!」のメッセージが表示される
- **オリジナル建築ブロック 23 種** (本家にはない独自ブロック):
