...
苔むした石レンガの**神殿ダンジョン**がそびえる。南側の入口から大広間へ入り,
奥の階段を地下へ降りると, グロウストーンに照らされた**ポータルの間**へたどり着く。
2 つの宝箱 (ダイヤ・金・エンダーパールなど) と, 渦を巻く水色の
**スカイポータル**がプレイヤーを待っている。
...
空島の中央は石レンガの**ボスアリーナ**になっており, 初めて訪れると
黄金の巨鳥 **「空の守護者」** (体力 120, ファイアボールを放つ) が現れる。
画面上部のボス HP バーを見ながら討伐すると, ダイヤモンドと金ブロックを
落とし, 大量の経験値 (300) が手に入る。アリーナの宝箱にはダイヤブロックや
金のリンゴなどの宝が眠っている。

島には水色の**空の鳥**が住んでいる。**小麦か種**を手に右クリックすると
手なずけられ (確率), 手なずけた鳥を右クリックすると**騎乗**できる。
騎乗中は移動キー + ジャンプ/スニークで**サバイバルでも自由に空を飛べる**
(F キーまたは飛行ボタンで降りる)。一度手なずけた鳥はワールドに記録され,
島に戻ればまた会える。帰りはアリーナ西側のスカイポータルで神殿へ戻れる。
