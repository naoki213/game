...
- **ブロック 65 種以上**: 基本ブロックに加え、建築向けに
  **色付き羊毛 12 色** (羊毛からクラフト)、
  **石材 8 種** (磨かれた石 / ひび割れ・模様入り石レンガ / 花崗岩 / 閃緑岩 /
  安山岩 / クォーツ / 黒レンガ)、**木材 3 色** (オーク / 白樺 / ダークオーク)、
  **ハーフブロック 5 種** (石 / 木材 / 石レンガ / レンガ / 砂岩)、
  氷・本棚・カボチャ・黒曜石・砂岩・TNT・チェスト・ベッドなど
...
- **道具**: ピッケル 4 種 (木/石/鉄/ダイヤ)、剣 4 種、弓。
  弓は右クリックで矢を発射し、離れた敵に命中させられる。
