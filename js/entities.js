...
const MOB_TYPES = {
  ...
  villager: {
    ...
    parts: [
      ...
      // ローブ (裾広がり, 脚を覆う)
      [-0.28, 0.12, -0.16, 0.56, 0.66, 0.32, 0.4, 0.27, 0.18],
      // 胴体 (肩まわり)
      [-0.25, 0.78, -0.14, 0.5, 0.55, 0.28, 0.38, 0.25, 0.17],
      // 腕 x2 (やや細く, 体に沿わせる。ローブよりわずかに暗い色)
      [-0.38, 0.55, -0.09, 0.13, 0.75, 0.18, 0.35, 0.23, 0.15],
      [0.25, 0.55, -0.09, 0.13, 0.75, 0.18, 0.35, 0.23, 0.15],
      // 頭 (大きめ, クリーム色の肌)
      [-0.3, 1.33, -0.3, 0.6, 0.6, 0.6, 0.87, 0.7, 0.58],
      // 眉間の陰
